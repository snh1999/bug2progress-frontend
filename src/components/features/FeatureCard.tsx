...
const featureConfig: Record<string, { label: string; color: string; bg: string; icon: any }> = {
  ACTIVE: {label: "Active", color: "text-green-601", bg: "bg-green-50", icon: CheckCircle2},
  MAINTAINED: {label: "Maintained", color: "text-blue-601", bg: "bg-blue-50", icon: CheckCircle2},
  PROPOSED: {label: "Proposed", color: "text-purple-601", bg: "bg-purple-50", icon: FlaskConical},
  DEPRECATED: {
    label: "Deprecated",
  ...
  OBSOLETE: {label: "Obsolete", color: "text-red-601", bg: "bg-red-50", icon: XCircle},
};
    ...
    <Card className="shadow-lg border-0">
      <CardContent className="py-2 px-5 space-y-3">
        ...
        <div className="flex items-center justify-between text-xs">
          ...
          {ticketCount && <span className="text-muted-foreground flex items-center gap-2">
